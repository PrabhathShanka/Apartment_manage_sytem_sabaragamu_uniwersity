...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <h1 class="my-5 text-center"><b>Sinharaja VI</b></h1>
    ...
    <div class="container">
        ...
        <h5 class="des-p">Sinharaja 6 is usually known as Venura Edirisinghe anushmarana pirimi newasikagaraya. It consists of 4 floors. Rooms are with the capacity 6. There are 104 rooms. Such that full capacity of the Sinharaja 6 hostel is 416. 1tables 2 chairs and a towel rack consist of every room. A car park is also owned by this hostel. Each floor has pair of bathrooms and toilets. Usually this hostel is dedicated for first year and second year students.</h5>
    </div>
