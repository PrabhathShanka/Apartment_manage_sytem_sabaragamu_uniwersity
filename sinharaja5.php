...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <h1 class="my-5 text-center"><b>Sinharaja V</b></h1>
    ...
    <div class="container">
        ...
        <h5 class="des-p">Sinharaja 5 is usually known as Mohammed Nishmi anushmarana pirimi newasikagaraya and it consists of 4 floors. Rooms are with the capacity 6 and 8. There are 72 rooms. So the full capacity of the Sinharaja 5 hostel is 480. 2 tables 4 chairs and a towel rack consist of every room. The speciality of this hostel is that this is the only hostel which has a canteen un sinharaja hostel complex. A car park is also owned by this hostel. A garden is situated in the middle of this hostel. Each floor has a bathrooms and toilets. Usually this hostel is dedicated for final year students.</h5>
    </div>
