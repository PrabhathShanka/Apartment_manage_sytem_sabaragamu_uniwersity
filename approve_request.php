...
if (isset($_GET['id'])) {
    ...
    $sql = "UPDATE apartments SET adminApproving = 'Approved' WHERE Apartment_ID = '$apartment_id'";

    // Execute the query
    if (mysqli_query($conn, $sql)) {
        // Redirect to a success page or back to the admin dashboard
        echo "<script>alert('Approving successfully!'); document.location.href = 'admin_dash.php';</script>";
        exit();
    } else {
        // Handle error
