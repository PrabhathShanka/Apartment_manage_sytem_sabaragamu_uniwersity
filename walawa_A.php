...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <h1 class="my-5 text-center"><b>Walawa A</b></h1>
    ...
    <div class="container">
        ...
        <h5 class="des-p">
               The ground floor houses approximately 30 bedrooms, while the upper floors accommodate around 45 rooms each. <br>
