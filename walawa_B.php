...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <h1 class="my-5 text-center"><b>Walawa B</b></h1>
    ...
    <div class="container">
        ...
        <h5 class="des-p">
        The ground floor houses approximately 25 bedrooms, while the upper floors accommodate around 45 rooms each. <br>
        ...
        <b>Room Amenities</b>
            <ul>
            <li> A six-person shared bedroom</li>
        ...
        Additionally, each room includes a private balcony, which students can use for drying clothes or for other practical purposes. These amenities are designed to ensure a comfortable and conducive living environment for female students.
</h5>
    </div>
