...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <h1 class="my-5 text-center"><b>Sinharaja IV</b></h1>
    ...
    <div class="container">
        ...
        <h5 class="des-p">Sinharaja 4 usually known as Shantha Bandara anushmarana pirimi newasikagaraya and it consists of 2 floors. Every room capacity is 2. Single beds are present in these rooms. Full capacity of the sinharaja 4 hostel is 128. 1 tables 1 chairs and a towel rack consist of every room. A garden is owned for this hostel. Each floor has a bathrooms and toilets. Usually this hostel is dedicated for final year students.</h5>
    </div>
